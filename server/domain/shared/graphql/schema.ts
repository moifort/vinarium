...
// Attachment domain (extends BeverageType with .attachments field)
import '~/domain/attachment/infrastructure/graphql/types'
import '~/domain/attachment/infrastructure/graphql/mutations'
