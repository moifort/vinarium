// Apple's root certificates, the trust anchors every App Store signature chains
// back to. Downloaded once from https://www.apple.com/certificateauthority/ and
// embedded as base64 rather than read from disk: the Nitro/Firebase bundle ships
// JavaScript, not a file tree, and these certificates change about once a decade
// (G3 is valid until 2039). Public data — nothing secret here.
...
/** The trust anchors passed to Apple's SignedDataVerifier. */
export const appleRootCertificates = (): Buffer[] =>
  [APPLE_COMPUTER_ROOT_CA, APPLE_INC_ROOT_CA, APPLE_ROOT_CA_G2, APPLE_ROOT_CA_G3].map(
